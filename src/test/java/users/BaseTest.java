...
public class BaseTest {
    ...
    String api_token = "https://staging-api.qongfu.com/api";
    ...
    public void authentication(int ID) throws FilloException, URISyntaxException {
        ...
        if( code == 202){
            ...
            String strQuery2 = "UPDATE CheckUsername set api_token = '" + api_token +"' WHERE code <> 401 OR ID = 1";
            String strQuery3 = "UPDATE UpdateUsername set api_token = '" + api_token +"' WHERE code <> 401 OR ID = 1";
